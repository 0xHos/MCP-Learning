export async function callGeminiLLM(prompt: string): Promise<string> {
  try {
    const response = await fetch(
      "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyDjUOI7Qf06APFOD_t-ediVcLNh8qVMh4E",
      {
        method: "POST",
...
export const initTool = (toolsList: any) => {
